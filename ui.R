...
shinyUI( navbarPage("Disease Risk Predictor"
                    ...
                    , tabPanel("Intro"
                               , h1("Introduction")
                               , h2("Purpose")
                               , p( "This website allows you to estimate disease risk for the individuals of a family")
                               ...
                               , HTML( "</OL>")
                               , p( "You should see a table appear on the right hand side of the Risk Prediction page. ")
                               , p( "This table is an abbreviated version of the pedigree information, each row representing a family member. ")
                               , p( "To this table has been added (rightmost column) the risk estimates for each family member. ")
                    ...
                    , tabPanel("Pedigree"
                               ,sidebarLayout(
                                 sidebarPanel( 
                                   ...
                                   ,p("Family information is specifed in ped file format.")
                                   ...
                                   , HTML( "</UL>")
                                   ,p("How this information relates to family tree should become apparent after looking at some example ped files and their accompanying pedigree diagrams.")
                                   , h4("Example")
                                   , em("Example pedigree = ped.3gen.tsv.") ,p(),p()
                                   ,p("Other columns are optional. However the following columns if they appear have special meanings - ")
                                   , HTML( "<UL>")
                                   , HTML( "<LI>deceased - indicates whether the person is deceased or living (affects pedigree diagram generation)")
                                   , HTML( "<LI>age - person's age (used in risk estimation for non-congenital diseases)")
                                   ...
                                   , h4("Example")
                                   , em("Example pedigree = ped.p2c.multipleTwins.tsv.") ,p(),p()
